...
def _compute_ica_activations(inst: Union[BaseRaw, BaseEpochs], ica: ICA) -> ndarray:
...
# ----------------------------------------------------------------------------
def _eeg_topoplot(
    inst: Union[BaseRaw, BaseEpochs], icawinv: ndarray, picks: List[str]
) -> ndarray:
    """Topoplot feature."""
...
# ----------------------------------------------------------------------------
def _eeg_rpsd(inst: Union[BaseRaw, BaseEpochs], ica: ICA, icaact: ndarray) -> ndarray:
    """PSD feature."""
...
def _resample(ac: ndarray, fs: Union[int, float]) -> ndarray:
